(function () {
  ...
  var extraClass = percent < 100 ? 'foreground--warning' : 'percent--good'

  var arcBackground = d3.svg.arc().startAngle(0).innerRadius((height * 0.95) * 0.36).outerRadius((height * 0.95) * 0.46)
    , arcForeground = d3.svg.arc().startAngle(0).innerRadius((height * 0.95) * 0.33).outerRadius((height * 0.95) * 0.48)
